...
import static utilz.Constants.PlayerConstants.resetPlayerAtk;;
...
public class Playing extends State implements Statemethods {
	...
	public boolean checkObjectHit(Rectangle2D.Float attackBox) {
		if(objectManager.checkObjectHit(attackBox))
			return true;
		return false;
	}
	...
	public void mouseClicked(MouseEvent e) {
		if (!gameOver)
			if (e.getButton() == MouseEvent.BUTTON1) {
				player.setFreefire(true);
				objectManager.fireArrow(player);
				getGame().getAudioPlayer().playAttackSound(player);
			}			
	}
